...
function loadGoogleMaps() {
    ...
    let key = "AIzaSyA7DUnjNzrfILoaLr2Sw0QHUxqrjs52l9E";
...
var gmapController = (function() {
    ...
    function initialize() {
        ...
        mapObjects.push({
            ...
            "infoContent": "<div class='info-window'><address>Universo Mascota<br/>Calle Cedri, Mercedes Sur,<br/>Heredia</address></div>",
            "infoIcon": "img/icono3.jpg"
        });
        ...
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function(pos) {
                mapObjects.push({
                    ...
                    "marker": null,
                    "title": "Su ubicacion",
                    "infoContent": "<div class='info-window'><p>Esta es su ubicacion actual.</p></div>",
                    "infoIcon": "img/walking.jpg"
                });
    ...
    return {
        ...
        "getDirections": function() {
            getDirections(document.getElementById("address").value,
                "Calle Cedri, Mercedes Sur, Heredia");
        },
